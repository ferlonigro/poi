...
//		POI poi = new POI("Baires Turistico");
//		
...
//		POI poi = new POI("Bs As Historico");
//		
//		String URL = BASE_URL + ":" + BASE_PORT + "/POIs/rest/pois/"+ poi.getServicio();
//	    PeticionPost post = new PeticionPost(URL);
//	    
//	    String respuesta = post.post();
...
//		POI poiTuristico = new POI("Baires Turistico");
//		
//		String URL = BASE_URL + ":" + BASE_PORT + "/POIs/rest/poismascercano/"+ poiTuristico.getServicio() + "/" + latLunaPark +"/"+ lonLunaPark;
//	    PeticionPost post = new PeticionPost(URL);
//	    
//	    
//	    String respuesta = post.post();
...
//		POI poiHistorico = new POI("Bs As Historico");
//		
//		String URL = BASE_URL + ":" + BASE_PORT + "/POIs/rest/poismascercano/"+ poiHistorico.getServicio() + "/" +latCongreso +"/"+ lonCongreso;
//		PeticionPost post = new PeticionPost(URL);
//	    
//	    String respuesta = post.post();
//	    Assert.assertEquals(true, respuesta.contains("CAFE DE LOS ANGELITOS")); 
